...
<?php $__currentLoopData = $receivedNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card <?php echo e(!$note->is_read ? 'card--unread' : ''); ?>">
...
<?php else: ?>
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('notes.update', $note)); ?>" class="form-inline">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            <textarea name="content" rows="2"><?php echo e($note->content); ?></textarea>
            <button type="submit">Оновити</button>
        </form>
        <form method="POST" action="<?php echo e(route('notes.destroy', $note)); ?>" class="form-inline"
