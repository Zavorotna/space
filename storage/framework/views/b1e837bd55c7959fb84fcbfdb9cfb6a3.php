...
<div class="report-section">
    ...
    <div class="report-item">
        ...
        <form method="POST" action="<?php echo e(route('teacher.schedule.complete', $lesson)); ?>" class="mt-1">
            ...
            <div id="makeup-<?php echo e($lesson->id); ?>" class="makeup-panel" style="display:none;">
                ...
                <div id="makeup-date-<?php echo e($lesson->id); ?>" class="makeup-date-row" style="display:none;">
...
<div class="mb-1">
    ...
    <span class="text-sm text-muted"><?php echo e($course->start_date?->format('d.m')); ?> — <?php echo e($course->end_date?->format('d.m')); ?></span>
    <?php if($course->applications()->where('status','pending')->count() > 0): ?>
    <a href="<?php echo e(route('teacher.courses.applications', $course)); ?>" class="text-sm">
