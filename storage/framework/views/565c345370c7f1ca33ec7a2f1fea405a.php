...
<form method="POST" action="<?php echo e(route('notifications.readAll')); ?>" class="form-inline">
    <?php echo csrf_field(); ?>
...
<?php else: ?>
    ...
    <div class="card <?php echo e(!$notification->is_read ? 'card--unread' : ''); ?>">
        ...
        <?php if(!$notification->is_read): ?>
            <form method="POST" action="<?php echo e(route('notifications.read', $notification)); ?>" class="form-inline">
                <?php echo csrf_field(); ?>
