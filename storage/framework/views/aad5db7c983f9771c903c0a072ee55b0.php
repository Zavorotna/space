        ...
        <tr>
            ...
            <td>
                <?php if($req->status === 'pending'): ?>
                    <form method="POST" action="<?php echo e(route('superadmin.withdrawals.approve', $req)); ?>" class="form-inline">
                        <?php echo csrf_field(); ?>
                        <input type="text" name="pickup_note" placeholder="Куди підійти для отримання" required>
                        <button type="submit">Підтвердити</button>
                    </form>
                    <form method="POST" action="<?php echo e(route('superadmin.withdrawals.reject', $req)); ?>" class="form-inline"
