        ...
        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" action="<?php echo e(route('teacher.courses.duplicate', $course)); ?>" style="display:inline;"
                          onsubmit="this.querySelector('button').disabled = true">
                        <?php echo csrf_field(); ?>
                        <button type="submit">Копіювати як курс</button>
                    </form>
                    <?php if(auth()->user()->isSuperAdmin()): ?>
                    <form method="POST" action="<?php echo e(route('teacher.courses.destroy', $course)); ?>" style="display:inline;">
