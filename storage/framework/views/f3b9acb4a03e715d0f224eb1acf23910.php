    ...
    <div>
        ...
        <?php if($submission->getMedia('files')->count()): ?>
            ...
            <?php $__currentLoopData = $submission->getMedia('files'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <img src="<?php echo e($media->getUrl()); ?>" alt="<?php echo e($media->file_name); ?>" style="max-width:200px;">
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        ...
        <div>
            ...
            <form method="POST" action="<?php echo e(route('homework.freeze', $submission)); ?>" style="display:inline;">
                <?php echo csrf_field(); ?>
                <label>Днів:
                    <select name="days">
