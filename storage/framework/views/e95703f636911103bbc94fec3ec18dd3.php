<?php $__env->startSection('title', 'Переказ'); ?>
<?php $__env->startSection('content'); ?>
<h1>Переказ</h1>
<p>Баланс: <strong><?php echo e($wallet->balance); ?></strong></p>

<form method="POST" action="<?php echo e(route('wallet.transfer.process')); ?>">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dmitropirizok/projects/hashtag-space-lms/resources/views/wallet/transfer.blade.php ENDPATH**/ ?>