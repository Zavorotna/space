...
<div>
    ...
    <form method="POST" action="<?php echo e(route('wallet.vip')); ?>" class="form-inline">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dmitropirizok/projects/hashtag-space-lms/resources/views/wallet/index.blade.php ENDPATH**/ ?>