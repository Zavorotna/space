...
<div class="card-panel">
    ...
    <form method="POST" action="<?php echo e(route('admin.locations.destroy', $location)); ?>" class="form-inline mt-1">
    ...
    <div class="classroom-row">
        <form method="POST" action="<?php echo e(route('admin.classrooms.update', $room)); ?>" class="form-inline flex-row">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.classrooms.destroy', $room)); ?>" class="form-inline">
            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.classrooms.store', $location)); ?>" class="mt-2">
        <?php echo csrf_field(); ?>
