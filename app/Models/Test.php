...
{
    protected $fillable = ['course_id', 'title', 'description', 'passing_score', 'sort_order', 'activation_topic_id'];

    public function course() { return $this->belongsTo(Course::class); }
    public function activationTopic() { return $this->belongsTo(CourseTopic::class, 'activation_topic_id'); }
